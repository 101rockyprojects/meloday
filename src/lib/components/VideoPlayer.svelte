<script>
    ...
    import Confetti from '@App/lib/components/Confetti.svelte';
    import Oops from '@App/lib/components/Oops.svelte';
    import Video from '@App/lib/components/Video.svelte';
    import { todayNumber } from '@App/lib/stores/todayNumber.js';
    import { playlistId, apiKey, specialDates } from '@App/lib/data/variables.js';
    import { getTodayVideo, getVideoById } from '@App/lib/functions/api';
    import { parseRoute } from '@App/lib/functions/routes.js';
    import { parseDate, getDayNumber, isSpecialDate } from '@App/lib/functions/dates.js';
    import { isSpecialDateToday } from '@App/lib/stores/isSpecialDateToday.js';
    ...
    async function initialize() {
      ...
      const { videoId: videoIdParam, day: dayParam, isSpecialDate: isSpecialDateParam } = parseRoute();

      let isSpecialToday = isSpecialDate(today, specialDates) || isSpecialDateParam;
